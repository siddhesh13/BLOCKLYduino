  ...
  init: function() {
    ...
    this.appendDummyInput()
    	...
    	.appendField(new Blockly.FieldDropdown([["D0", "D0"], ["D1", "D1"], ["D2", "D2"], ["D3", "D3"], ["D4", "D4"],["D5", "D5"],
        										["D6", "D6"],["D7", "D7"], ["D8", "D8"], ["D9", "D9"], ["D9", "D9"],["D10", "D10"]]), "Trigger")
    this.appendDummyInput()
    	.setAlign(Blockly.Align_RIGHT)
    	.appendField("Echo Pin:")
    	.appendField(new Blockly.FieldDropdown([["D0", "D0"], ["D1", "D1"], ["D2", "D2"], ["D3", "D3"], ["D4", "D4"],["D5", "D5"],
        										["D6", "D6"],["D7", "D7"], ["D8", "D8"], ["D9", "D9"], ["D9", "D9"],["D10", "D10"]]), "Echo")
    this.appendDummyInput()
    	.setAlign(Blockly.Align_RIGHT)
    	.appendField("Unit:")
...
Blockly.Blocks['analog_read'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["A0", "A0"]]), "PIN");
    this.setOutput(true, 'Number');
...
Blockly.Blocks['MoveReverse'] = {
  init: function() { 
	...
	this.setNextStatement(true);
    this.setColour(160);
    this.setTooltip('Returns number of fs in the provided text.');
    this.setHelpUrl('http://www.w3schools.com/jsref/jsref_length_string.asp');
  }
};
